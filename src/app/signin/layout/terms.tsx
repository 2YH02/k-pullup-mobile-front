      ...
      <div>
        <div className="max-w-3xl mx-auto bg-white dark:bg-black shadow-full rounded-lg p-6">
          ...
          <Section title="제1조 목적">
            본 이용약관은 <strong>대한민국 철봉 지도</strong>(이하 &#39;서비스&#39;)의
            이용 조건과 운영에 관한 사항을 규정합니다.
          </Section>
          ...
          <Section title="제6조 운영자의 의무">
            운영자는 안정적 서비스 제공 및 회원의 의견·불만을 신속히 처리하기
            위해 최선을 다합니다.
          </Section>
          ...
          <Section title="제13조 손해배상 및 면책">
            <ul className="list-disc list-inside space-y-1 mt-2">
              <li>
                회원 과실로 인한 손해에 대한 책임은 회원 본인에게 있습니다.
              </li>
              <li>
                천재지변, 해킹 등 불가항력적 사유로 인한 피해는 면책됩니다.
              </li>
              <li>
                회원 간·회원과 제3자 간 분쟁은 서비스가 책임지지 않습니다.
              </li>
            </ul>
          </Section>
...
export const Section = ({
  ...
  return (
    <div className="mb-6">
      ...
      <div className="text-grey-dark dark:text-grey-light text-sm leading-relaxed">{children}</div>
    </div>
  );
};
